...
Feature: Drag and drop a file onto a course section
  ...
  Scenario: A teacher drops a file onto a course section
    ...
    When I drop file "lib/tests/fixtures/empty.txt" on "Topic 1" "core_courseformat > Section"
    Then I should see "empty.txt" in the "Topic 1" "core_courseformat > Section"
